...
<h3>Notice</h3>
<p>If you installed OpenServer on Windows go to "OSPanel/userdata/config". There open "php.ini" file of php version you are using. Find line "output_buffering" and change the value to 4096.</p>
